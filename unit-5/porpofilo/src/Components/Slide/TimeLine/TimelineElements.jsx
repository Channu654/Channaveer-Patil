...
function ChronoTimeline({ currentTheme }) {
  const items = [
    ...
    {
      title: 'June 2015 - October 2018',
      cardSubtitle: 'Guru Nanak Dev Engineering College Bidar',
      cardTitle: 'B.E Mechanical Engineer',
      cardDetailedText: ['An undergraduate Mechanical Engineering course'],
    },
    // {
    ...
    // },
    {
      title: 'June 2012- May 2015',
      cardSubtitle: 'Government Polytechnic Bidar',
      // cardTitle: 'Pre-University College',
      cardDetailedText: [
        'An intermediate course of three years duration, conducted by Department of Technical Education Bangalore.',
      ],
    },
  ];
