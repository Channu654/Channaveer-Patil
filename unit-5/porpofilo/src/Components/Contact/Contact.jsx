      ...
      <ContactMain>
        ...
        <FindMeElseWhere>
          <div title='Click here to call'>
            <div>
              <a target='_blank' rel='noreferrer' href='tel:+919731846925'>
          ...
          <div title='Click here to mail'>
            <div>
              <a
                target='_blank'
                rel='noreferrer'
                href='mailto:channaveerpatil@gmail.com'>
            ...
            <div>
              <a
                target='_blank'
                rel='noreferrer'
                href='mailto:channaveerpatil999@gmail.com'>
                <p>channaveerpatil999@gmail.com</p>
              </a>
            </div>
          </div>
          <div title='Click here go to github profile'>
            <div>
              <a
                target='_blank'
                rel='noreferrer'
                href='https://github.com/Channu654'>
            ...
            <div>
              <a
                ...
                rel='noreferrer'
                href='https://github.com/Channu654'>
                <p>https://github.com/Channu654</p>
              </a>
            </div>
          </div>
          <div title='Click here go to linkedin profile'>
            <div>
              <a
                target='_blank'
                rel='noreferrer'
                href='https://www.linkedin.com/in/channaveer-patil-704bb017a/'>
            ...
            <div>
              <a
                ...
                rel='noreferrer'
                href='https://www.linkedin.com/in/channaveer-patil-704bb017a/'>
                <p>linkedin.com/in/channaveer-patil</p>
              </a>
            </div>
          </div>
          {/* medium */}
